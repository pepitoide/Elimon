...
const embed_ayuda = new Discord.EmbedBuilder()
	.setColor("8530ba")
	.setAuthor({ name: "Elimon Bot", iconURL: `https://media.discordapp.net/attachments/1069298129410740385/1077551402294988810/latest.png`, url: "https://discord.com/api/oauth2/authorize?client_id=1005068181913751612&permissions=8&scope=bot" })
...
function embed_music(txt) {
	const em_music = new Discord.EmbedBuilder()
		.setColor("F6FFF8")
		.setAuthor({ name: "Elimon Music", iconURL: `https://media.discordapp.net/attachments/1069298129410740385/1077551402294988810/latest.png`, url: "https://discord.com/api/oauth2/authorize?client_id=1005068181913751612&permissions=8&scope=bot" })
		.setDescription(`${txt}`)
		.setTimestamp()
	return (em_music)
}

function embed_elimon(op, val1, val2, val3) {

	if (op == 1) {
		let em_elimon = new Discord.EmbedBuilder()
			.setColor("ffe0ff")
			.setAuthor({ name: "Elimon", iconURL: `https://media.discordapp.net/attachments/1069298129410740385/1077551402294988810/latest.png`, url: "https://discord.com/api/oauth2/authorize?client_id=1005068181913751612&permissions=8&scope=bot" })
			.setDescription(`${val1}`)
			.setTimestamp()
...
function embed_logs(title, txt) {
	const em_music = new Discord.EmbedBuilder()
		.setColor("98ff96")
		.setAuthor({ name: "Elimon Logs", iconURL: `https://media.discordapp.net/attachments/1069298129410740385/1077551402294988810/latest.png`, url: "https://discord.com/api/oauth2/authorize?client_id=1005068181913751612&permissions=8&scope=bot" })
		.setTitle(`${title}`)
		.setDescription(`${txt}`)
		.setTimestamp()
	return (em_music)
